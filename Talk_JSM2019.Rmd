...
- **Hi-C sequencing** (Chromatin Conformation Capture technology) allowa for identification of genomic interactions genome-wide
...
1. Cut out a window from the matrix equal to the maximum size of a TAD (2Mb)
...
- Currently available and fully functional at http://bioconductor.org/packages/SpectralTAD/
...
- Output: A 3-column BED file output for each hierarchy level, visualization options include output for `Juicebox`
