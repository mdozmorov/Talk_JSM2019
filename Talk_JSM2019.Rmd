...
\begin{center}
\includegraphics[width=203px,height=363px]{./Talk_JSM2019-figure/TAD_Plot.png}
\end{center}
...
\begin{center}
\includegraphics{./Talk_JSM2019-figure/Hierarchical_TADs.png}
\end{center}
...
![](./Talk_JSM2019-figure/Fig_4.png){width=100%;height=100%}
